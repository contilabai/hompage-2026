...
const patentDetails = {
  p1: { title: "Video-Based Risk Detection AI for Construction Sites", titleKo: "건설현장에서 영상 기반 위험판별 AI의 위험상황 기록 시스템 및 분석방법", desc: "This patent introduces an AI-based risk event recording and analysis system for construction sites. The technology utilizes deep learning-based object detection models, including YOLO-based video analysis, to identify hazardous situations involving workers, equipment, and materials in real time. The system determines unsafe conditions by analyzing bounding-box detection frequency, dynamic and static risk factors, and rule-violation events over continuous video frames.\n\nThe invention enables automatic recording and storage of dangerous events when predefined risk thresholds are exceeded, significantly improving safety monitoring efficiency and reducing manual supervision requirements. The technology is optimized for construction environments where rapid detection and event traceability are critical for accident prevention and compliance management.", image: "/images/patent/p1.png" },
  p2: { title: "Simultaneous Vertical & Horizontal Hazard Detection System", titleKo: "건설현장에서 수직-평면 동시 위험작업 탐지를 위한 영상분석 시스템", desc: "This patent presents a video analytics system capable of simultaneously detecting hazardous activities occurring in both vertical and horizontal workspaces within construction environments. The system identifies multiple object classes from video streams, generates bounding boxes for detected workers and equipment, and evaluates dangerous conditions according to task-specific risk scenarios.\n\nBy analyzing consecutive frames over a defined period, the system determines whether a hazardous event has occurred and records the event automatically. The invention is particularly effective for detecting falls, overhead work risks, crane-related hazards, and unsafe interactions between workers and heavy machinery in complex construction environments.", image: "/images/patent/p2.png" },
  p3: { title: "Dynamic Object Collision Prediction for Industrial Safety", titleKo: "산업 현장에서 동적 객체의 충돌을 예측하는 방법 및 산업 현장 안전 모니터링 장치", desc: "This patent proposes a predictive safety monitoring technology capable of forecasting collisions between moving objects in industrial environments. The system analyzes trajectories, movement patterns, and spatial relationships between workers, vehicles, and machinery to predict potential collision risks before accidents occur.\n\nThe invention enhances proactive safety management by providing early warning notifications and automated monitoring functions for industrial facilities and construction sites. It is designed for integration with smart surveillance systems and AI-based industrial safety platforms.", image: "/images/patent/p3.png" },
  p4: { title: "AI Camera & Cloud-Based Safety Monitoring System", titleKo: "산업 현장 안전 모니터링을 위한 인공지능 카메라, 클라우드 서버 및 시스템", desc: "This invention describes an integrated AI camera and cloud server platform for industrial site safety monitoring. The system combines intelligent video acquisition, AI-based hazard analysis, and cloud-based centralized management to provide scalable safety monitoring across multiple industrial sites.\n\nThe platform supports real-time video analytics, abnormal event detection, worker activity monitoring, and remote management functions. By integrating AI cameras with cloud infrastructure, the system enables efficient large-scale deployment while supporting centralized data storage and intelligent risk analysis.", image: "/images/patent/p4.png" },
  p5: { title: "Lightweight AI Optimization for Mobile Applications", titleKo: "모바일 어플리케이션 구동을 위한 영상기반 위험판별 경량 AI 가중치 최적화 방법 및 장치", desc: "This patent introduces a lightweight AI optimization method designed for mobile and edge devices operating under limited computing resources. Using TensorFlow Lite-based lightweight runtime architectures, the invention minimizes computational overhead while maintaining efficient deep-learning inference performance on CPUs and NPUs.\n\nThe optimized AI model enables real-time risk detection on smartphones and embedded edge devices, supporting industrial safety applications where low latency and reduced power consumption are essential. The technology significantly improves portability and scalability of AI-based safety monitoring solutions.", image: "/images/patent/p5.png" },
  p6: { title: "BIM-Based Optimal Camera Placement System", titleKo: "BIM 모델과 연동된 감시 카메라 최적 배치 방법 및 장치", desc: "This patent provides a BIM-integrated simulation system for optimizing surveillance camera placement within construction sites. The technology extracts geometric and scheduling information from 4D BIM models and generates virtual construction site layouts reflecting time-dependent construction progress.\n\nThe system simulates surveillance coverage areas using virtual camera models and automatically generates optimal camera deployment plans according to construction stages. This enables efficient monitoring coverage, reduced blind spots, and improved safety management throughout the construction lifecycle.", image: "/images/patent/p6.png" },
  p7: { title: "AI-Based Construction Accident Prediction System", titleKo: "이미지 인식 프로세스 기반 건설현장 사고 예측 시스템 및 예측방법", desc: "This patent utilizes image recognition and AI-based analysis techniques to predict potential accidents in construction environments. By analyzing visual patterns, worker behavior, and environmental conditions, the system identifies high-risk situations before accidents occur.\n\nThe technology supports intelligent safety decision-making by continuously monitoring site conditions and generating predictive risk assessments. It contributes to proactive accident prevention and smart safety management in digital construction environments." },
  p8: { title: "Safety Compliance Management Platform", titleKo: "건설 현장의 안전 지침을 점검하는 방법 및 이를 수행하는 서버", desc: "This invention provides a digital platform for verifying compliance with construction safety guidelines and operational procedures. The server-based system automatically checks work activities against predefined safety regulations and operational standards.\n\nThe platform improves construction safety governance by enabling automated compliance auditing, safety documentation management, and real-time monitoring of procedural violations. It supports efficient safety administration and regulatory compliance management across construction projects." },
  p9: { title: "Blockchain-Based Construction Quality Management System", titleKo: "블록체인 기반 건설공사 품질관리 방법 및 시스템", desc: "This patent introduces a blockchain-based quality management framework for construction projects. The system securely stores quality management records, including photos, videos, BIM data, sensor information, and work documentation, while preventing tampering and unauthorized modifications.\n\nThe technology performs quality compliance verification through blockchain validation and external platform integration. By storing data hashes and verification records on a blockchain network while maintaining original data in off-chain databases, the system ensures transparency, traceability, and reliability of construction quality management processes.", image: "/images/patent/p9.png" },
  p10: { title: "Industrial Safety Monitoring Edge Device & Cloud System", titleKo: "산업 현장 안전 모니터링을 위한 엣지 디바이스, 클라우드 서버 및 시스템", desc: "This patent describes an edge AI-based industrial safety monitoring architecture combining edge devices, cloud servers, and intelligent analytics systems. The platform performs real-time AI inference directly on edge devices while synchronizing critical monitoring data with cloud infrastructure.\n\nThe system minimizes latency, reduces network traffic, and enables scalable deployment of intelligent safety monitoring services across industrial and construction sites. It is optimized for AI-based surveillance, real-time hazard detection, and distributed industrial IoT environments.", image: "/images/patent/p10.png" },
  p11: { title: "PTZ Camera Control-Based Risk Event Detection Technology", titleKo: "카메라 PTZ 제어를 이용하는 위험 이벤트 검출 방법, 장치 및 시스템", desc: "This invention provides an intelligent PTZ (Pan-Tilt-Zoom) camera control system capable of dynamically tracking hazardous situations in industrial environments. The technology automatically adjusts camera direction and zoom levels according to detected risk events, enabling more precise monitoring of workers, equipment, and hazardous zones.\n\nBy integrating AI-based event recognition with automated PTZ control, the system improves surveillance responsiveness, reduces manual camera operation, and enhances detection accuracy for safety-critical events in complex industrial sites." },
  p12: { title: "Virtual Data Generation for Construction Safety", titleKo: "건설 현장의 안전 사고 방지를 위한 가상 데이터 생성 방법 및 그 장치", desc: "This patent generates synthetic 3D virtual construction environments using game-engine-based simulations and 3D object models. The technology automatically creates labeled training datasets for AI safety systems by simulating interactions among workers, equipment, and construction objects.\n\nThe generated virtual datasets improve AI training efficiency, support rare hazard scenario generation, and enhance the accuracy of safety-related computer vision models for construction environments." },
  p13: { title: "Linked Data-Based Safety Information Sharing Platform", titleKo: "링크드 데이터 기반의 안전정보 공유 장치 및 방법", desc: "This patent establishes a linked-data framework for integrating and sharing construction safety information across distributed organizations and systems. The platform combines BIM data, unstructured web data, accident cases, technical documents, and safety regulations into a unified RDF-based knowledge structure.\n\nThe system supports semantic reasoning and SPARQL-based information retrieval, enabling intelligent safety knowledge sharing and context-aware safety recommendations within smart construction environments.", image: "/images/patent/p13.png" },
  p14: { title: "Blockchain-Based Facility Procurement & Installation Management System", titleKo: "블록체인 기반 시설물 조달 설치 통합관리시스템 및 통합관리방법", desc: "This patent introduces a blockchain-enabled integrated management platform for procurement, installation, inspection, and lifecycle management of construction facilities and materials. The system assigns role-based permissions to stakeholders and validates process integrity through blockchain-based comparison and verification mechanisms.\n\nThe technology improves transparency, trustworthiness, and traceability throughout the construction supply chain and facility installation process." },
};
                  ...
                  <ul className="space-y-1">
                    {group.items.map((key) => {
                      ...
                      return (
                        <li key={key}>
                          <button
                            onClick={() => { setModalContent({ title: language === "ko" ? p.titleKo : p.title, desc: p.desc, cat: group.cat, index, image: "image" in p ? p.image : undefined }); setModalOpen(true); }}
                          ...
                          >
                            ...
                            <span className="flex-1">{language === "ko" ? p.titleKo : p.title}</span>
