...
const news = [
  {
    ...
    title: "방문자 관리 기능 업데이트 안내",
    desc: "현장 방문자 사전 등록 및 출입 관리 기능이 업데이트되었습니다. QR코드 기반 비접촉 출입 관리를 지원합니다.",
    href: "#news-1",
  },
  {
    date: "2026.05.15",
    ...
    title: "안전모 미착용 AI 감지 정확도 99% 달성",
    desc: "딥러닝 모델 업그레이드로 안전모 미착용 감지 정확도가 99%로 향상되었습니다. 야간 및 역광 환경에서도 정확한 감지가 가능합니다.",
    href: "#news-2",
  },
  {
    date: "2026.05.08",
    ...
    title: "2026년 중대재해처벌법 시행 가이드",
    desc: "중대재해처벌법 적용 범위 확대에 따른 대응 가이드를 배포합니다. 50인 이상 사업장의 필수 준수 사항을 확인하세요.",
    href: "#news-3",
  },
  {
    date: "2026.04.28",
    category: "업데이트",
    categoryColor: "bg-blue-100 text-blue-700",
    title: "대시보드 UI 개편 및 성능 개선",
    desc: "더 빠르고 직관적인 대시보드로 개편했습니다. 현장별 안전 현황을 한눈에 파악할 수 있도록 시각화를 강화했습니다.",
    href: "#news-4",
  },
];
...
const blogPosts = [
  {
    ...
    title: "스마트 안전장비 도입 전 꼭 알아야 할 5가지",
  ...
  },
  {
    ...
    title: "AI CCTV 도입 후 재해율 40% 감소한 OO건설 사례",
  ...
  },
  {
    ...
    title: "2026년 달라지는 건설현장 영상기록 의무 총정리",
    ...
    <section id="news" className="py-20 bg-gray-50">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            <p className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-2">소식·공지</p>
            <h2 className="text-2xl font-black text-gray-900">최신 소식</h2>
          </div>
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            <p className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-2">블로그</p>
            <h2 className="text-2xl font-black text-gray-900">전문가 인사이트</h2>
          </div>
